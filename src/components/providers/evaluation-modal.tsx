...
import { EVALUATION_CRITERIA, EVALUATION_TYPE_NAMES, type EvaluationType } from '@/lib/evaluations';
...
export function EvaluationModal({ isOpen, onClose, provider, evaluationType }: EvaluationModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          <DialogTitle>{EVALUATION_TYPE_NAMES[evaluationType]}</DialogTitle>
          <DialogDescription>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <span className="font-bold w-8 text-center">{field.value}</span>
                      </div>
                      <FormMessage />
                    </FormItem>
                  )}
